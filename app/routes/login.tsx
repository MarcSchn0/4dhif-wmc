...
export const action: ActionFunction = async ({ request }) => {
    ...
    switch (action) {
        ...
        case 'register': {
            ...
            return await register({ email, password, firstName, lastName, department })
        }
        default:
...
export default function Login() {
    ...
    // Effekt, um formError zu bereinigen, wenn die Formulardaten geändert werden
    useEffect(() => {
        if (!firstLoad.current) {
            setFormError('')
        }
    ...
    // Effekt, der nur einmal beim ersten Laden ausgeführt wird
    useEffect(() => {
