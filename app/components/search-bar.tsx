...
export function SearchBar({firstName, lastName, profilePicture}: props) {
    ...
    const handleSubmit = (event: { preventDefault: () => void; }) => {
        ...
        // Update the search parameters when the form is submitted
        if (filterValue) {
    ...
    return (
        <form onSubmit={handleSubmit} className="w-full px-6 flex items-center gap-x-4 border-b-4 border-b-blue-900 border-opacity-30 h-20">
